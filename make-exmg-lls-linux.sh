...
#./configure --enable-gpl --enable-openssl --enable-version3 --disable-sdl2 --enable-debug --disable-ffplay --disable-libxcb --disable-libxcb-shm --disable-indev=sndio --disable-outdev=sndio --disable-outdev=xv --enable-libx264  --enable-nonfree --pkg-config-flags=--static --prefix="output"
